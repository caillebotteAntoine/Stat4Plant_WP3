...
{\Large Ordre du jour : \\ 10 Novembre 2022}

\vspace{2cm}

\begin{myEnumerate}{inraeCyan}
    \item Reformulation objectif : article : \by{Antoine}
    \myRemarks{
        \item C'est quoi exactement l'objectif de l'article
        \item valeur ajouter ? (model joint ?)
    }
